...
extern void ssd1306_init(i2c_inst_t *i2c, uint8_t address, uint8_t width, uint8_t height);
...
extern void ssd1306_show();
extern void ssd1306_draw_filled_rect(int x, int y, int width, int height, int color);
...
// Funções para bitmap (se for usar)
