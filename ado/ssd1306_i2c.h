...
#define ssd1306_height 64 // Define a altura do display (32 ou 64 pixels)
...
#define ssd1306_i2c_clock 400 // Define o tempo do clock (em kHz, pode ser aumentado)
...
#define ssd1306_set_common_output_direction_flip _u(0xC0) // Alias para 0xC8
...
// Estrutura para definir uma área de renderização no display
struct render_area
{
...
// Estrutura para o driver do SSD1306 (usado principalmente para bitmap)
typedef struct
{
    ...
    uint8_t *ram_buffer;
    size_t bufsize;
    uint8_t port_buffer[2]; // Buffer para comandos I2C
} ssd1306_t;
